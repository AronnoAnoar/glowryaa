                ...
                <table class="table table-bordered moha_tbl_inv" style="margin-top: 5px;">
                    ...
                    <tr>
                        <th colspan="2" class="text-left"> Name &nbsp;:
                         ...
                         <th colspan="4" class="text-left"> Phone &nbsp;:
                            <span style="font-size:15px;">
                                {{ $order->mobile_no ?? "" }}
                            </span>
                        </th>
                        <th colspan="4" class="text-left">Invoice No : {{ $order->invoice_no }} - {{ $order->id  }} </th>
                    </tr>

                    <tr>
                        <td colspan="2" class="text-left" style="text-transform: capitalize;"><b>Address  : </b><b> {{ $order->address. ',' }} </b> </td>
                    </tr>
                    ...
                    @foreach($order->SaleItems as $k=> $item)
                        ...
                        @endforeach
                    <tr>
                        <td colspan="7" class="text-right"><span style="font-weight: 900; font-size: 13px;">Sub-Total:</span></td>
