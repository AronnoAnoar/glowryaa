...
Route::group(
    ...
    function () {
        ...
        Route::get(
            'api/contacted/customer/search/{data}',
            'OthersController@search_contacted_customer'
        );
        Route::get(
            'api/reply/message/to/contacted/customer/{to}/{subject}/{message}',
            'Contact_replyController@reply_contacted_customer'
        );
        ...
        Route::get(
            'api/customers/export/wholesale',
            'CustomerController@export_wholesale_customers'
        );
        Route::get(
            'api/export//customers/officesale',
            'CustomerController@export_officesale_customers'
        );
        ...
        Route::get(
            '/subCategory/wise/subSubCategory/{id}',
            'SubCategoryController@subCategoryWiseSubCategory'
        );
        ...
        //apply discount
        Route::post(
            'api/sub-sub-category/discount/add/{id}',
            'SubSubCategoryController@addDiscount'
        );
        ...
        //start the happy customer routes
        Route::get('/list/happy-customer', 'HappyCustomerController@index');
        Route::post('/happy-customer/add', 'HappyCustomerController@store');
        Route::get('/happy-customer/edit/{id}', 'HappyCustomerController@edit');
        Route::post('/happy-customer/update/{id}', 'HappyCustomerController@update');
        Route::get('/active/happy-customer/{id}', 'HappyCustomerController@active');
        Route::get('/deActive/happy-customer/{id}', 'HappyCustomerController@deActive');
        Route::get('/delete/happy-customer/{id}', 'HappyCustomerController@destroy');
        
        
        //start the Reselling Slider route
        
        
         Route::get('/list/reselling/slider', 'SliderController@reselling_index');
         Route::post('/reselling/slider/add', 'SliderController@reselling_store');
         Route::get('/get/edit/reselling/slider/{id}', 'SliderController@get_edit_reselling_slider');
         Route::post('/reselling/slider/update/{id}', 'SliderController@update_reselling_slider');
         Route::get('active/reselling/slider/{id}', 'SliderController@reselling_active');
         Route::get('deActive/reselling/slider/{id}', 'SliderController@reselling_deActive');
         Route::get('delete/reselling/slider/{id}', 'SliderController@reselling_slider_destroy');
        ...
        Route::get(
            'api/category/get/edit/slider/{id}',
            'SliderController@get_category_slider_edit'
        );
        ...
        Route::get(
            'api/category/deActive/slider/{id}',
            'SliderController@deActive_category_slider'
        );
        ...
        Route::post('/api/cancel/order', 'OrderController@cancel');
        ...
        Route::get('packaging/all/order/{id}', 'OrderController@packagingAll');
        ...
        Route::get('update/commission/reseller/order/{id}','OrderController@updateResellerCommison');
       ...
       //order processing report
        ...
        //service  has start
        Route::get('api/service/list', 'ServiceController@index');
        Route::post('api/service/add', 'ServiceController@adServices');
        Route::get('api/service/get/{id}', 'ServiceController@serviceItem');
        Route::post('api/service/edit/{id}', 'ServiceController@editServices');
        Route::get('api/service/active/{id}', 'ServiceController@activeServices');
        Route::get('api/service/deactive/{id}', 'ServiceController@deactiveServices');

        //reseller service
         Route::get('api/reseller/service/list', 'ServiceController@reselling_service_index');
         Route::post('api/reseller/service/add', 'ServiceController@add_reselling_services');
         Route::get('api/reseller/service/edit/{id}', 'ServiceController@get_edit_reselling_service');
         Route::post('api/reseller/service/update/{id}', 'ServiceController@get_update_reselling_service');
         Route::get('api/reseller/service/delete/{id}', 'ServiceController@get_delete_reselling_service');


         //reseller rules start
         Route::get('api/reseller/rule/list', 'ResellerRuleController@index');
         Route::post('api/reseller/rule/add', 'ResellerRuleController@store');
         Route::get('api/reseller/rule/edit/{id}', 'ResellerRuleController@edit');
         Route::post('api/reseller/rule/update/{id}', 'ResellerRuleController@update');
         Route::get('api/reseller/rules/delete/{id}', 'ResellerRuleController@destroy');



         Route::get('api/reseller/service/get/{id}', 'ServiceController@serviceItem');
         Route::get('api/reseller/service/active/{id}', 'ServiceController@activeServices');
         Route::get('api/reseller/service/deactive/{id}', 'ServiceController@deactiveServices');
        ...
        //balance routes
        Route::get('api/balance/list', 'AccountController@balance');
       ...
       //advertise banner
        ...
        Route::get('api/credit/statement/list', 'BillStatementController@creditList');
        ...
        Route::get(
            'api/campaign/product/remove/{productId}',
            'CampaignController@removeProductfromProduct'
        );
        Route::get(
            'api/campaign/product/remove/{productId}',
            'CampaignController@removeProductfromProduct'
        ...
        Route::get(
            'api/product/assign/to/campaign/{product_code}',
            'CampaignController@assignProduct'
        );
        Route::get('api/campaign/product/{campaign_id}', 'CampaignController@campaignProducts');
        Route::get('api/deActive/campaign/{campaign_id}', 'CampaignController@deactive');
        Route::get('api/active/campaign/{campaign_id}', 'CampaignController@active');
        ...
        Route::get('deActive/brand/{id}', 'BrandController@deActive');
        ...
        /******** start landing page solution routes ********/
        ...
        /******** end landing page solution routes ********/
