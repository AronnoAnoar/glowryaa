<div class="product_card">
    ...
    <div class="product_content">
        ...
        <div class="product_price">
            <span class="product_new_price"><?php echo e($product->sale_price); ?> ৳</span>
            <?php if($product->price > $product->sale_price): ?>
                <span class="product_discount_price"><?php echo e($product->price); ?> ৳</span>
            <?php endif; ?>
        </div>
...
</div><?php /**PATH /home/hurayaac/glowryaa.com/resources/views/frontend/components/product_content.blade.php ENDPATH**/ ?>