             ...
             <div class="row">
                 <div class="col-xxl-12">
                     <div class="happy_customer_active owl-carousel">
                         <?php if(isset($happyCustomers) && $happyCustomers->count() > 0): ?>
                             <?php $__currentLoopData = $happyCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <div class="customer_item" style="margin: 0 10px;">
                                     <img src="<?php echo e(asset('storage/' . $customer->image)); ?>" alt="<?php echo e($customer->alt_text ?? 'Happy Customer Review'); ?>" style="border-radius: 8px; border: 1px solid #eee;">
                                 </div>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <?php endif; ?>
                     </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hurayaac/glowryaa.com/resources/views/frontend/pages/index.blade.php ENDPATH**/ ?>