                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="zooming_image_content">
                        <div class="zooming_show_image">
                            <?php if(!empty($product->productImage[0]['image'])): ?>
                                <img src="<?php echo e(asset('storage/' . $product->productImage[0]['image'])); ?>"
                                    alt="<?php echo e($product->productImage[0]); ?>">
                            <?php else: ?>
                                <img src="<?php echo e(asset('storage/images/products/defult_product_image.jpg')); ?>" alt="defult_product_image.jpg">
                            <?php endif; ?>
                        </div>
                            ...
                            <ul>
                                ...
                                <?php $__currentLoopData = $product->productImage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li <?php if($index == 0): ?>
                                        ...
                                        <?php endif; ?>
                                    >
                                        <img src="<?php echo e(asset('storage/' . $image->image)); ?>" onclick=" showImg(this.src)" class="clickable-image">
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <?php if(!empty($product->video_url) && isset($product->video_url)): ?>
                                    <!-- Modal -->
                                            ...
                                            <div class="video_modal_content">
                                                ...
                                                <div class="youtube_video">
                                                    <iframe width="100%" height="100%"
                                                        src="<?php echo e($product->video_url); ?>?autoplay=1" autoplay="true"
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="single_product_details">
                        ...
                        <div class="single_product_whatsapp">
                            <a href="https://wa.me/<?php echo e($general_settings->whatsapp_number); ?>" class="single_product_whatsapp_link">
                        ...
                        <div class="single_product_attribute">
                            ...
                            <div class="single_product_price">
                                <span class="single_product_new_price" id="single_product_page_variant_wise_sale_price"><?php echo e($product->sale_price); ?> TK</span>
                                <?php if($product->price > $product->sale_price): ?>   
                                    <span class="single_product_discount_price"><?php echo e($product->price); ?> TK</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php if($variand_count > 0): ?>    
                            <div class="single_product_attribute">
                                ...
                                <div class="single_product_size_checkbox_list" id="product_variant">
                                    <ul>
                                        <?php $__currentLoopData = $product->productVariant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <div class="single_product_size_checkbox_list_group variant">
                                                    <input type="radio" name="variant" onclick="getVariant(this.id); getVariantWiseProductPrice( this.id ,'<?php echo e($product->id); ?>');" id="<?php echo e($variant->variant->id); ?>">
                            ...
                            <div class="row gx-3">
                                <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                    <div class="single_product_qty">
                                        <div class="single_product_qty_btn_minus">
                                            <button type="button" onclick="decrement()" class="single_product_qty_minus">
                                                <i class="fa-solid fa-minus"></i>
                                            </button>
                                        </div>
                                        <input class="product_qty" type="text" value="1" min="1">
                                        <div class="single_product_qty_btn_minus">
                                            <button type="button" onclick="Increment()" class="single_product_qty_plus">
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                    <div class="single_product_buy_now_btn">
                                        <a href="#" id="<?php echo e($product->id); ?>" data-variant="<?php echo e($variand_count); ?>" onclick="buyNow(this.id, this.getAttribute('data-variant'))"
                        ...
                        <div class="single_product_btn_group">
                            <div class="row gx-3">
                                <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                    <button type="button" id="<?php echo e($product->id); ?>" data-variant="<?php echo e($variand_count); ?>" class="single_product_add_to_cart"
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                    <button class="single_product_add_to_wishlist" id="<?php echo e($product->id); ?>"  data-variant="<?php echo e($variand_count); ?>"
                    ...
                    <div class="single_product_specification_content">
                                ...
                                <?php if(count($delivery_charges) > 0): ?>
                                    <?php $__currentLoopData = $delivery_charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery_charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                        <li>
                                            ...
                                            Delivery Charge <?php echo e($delivery_charge->name); ?>  <?php echo e($delivery_charge->delivery_charge); ?> TK
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single_product_call_details">
                            ...
                            <div class="single_product_call">
                                <ul>
                                    <li>
                                        <a href="tel:<?php echo e($general_settings->header_contact_number); ?>" class="single_product_call_link">
                                    ...
                                    <li>
                                        <a href="tel:<?php echo e($general_settings->header_contact_number_two); ?>" class="single_product_call_link">
                                            <div class="single_product_call_content">
                                                <i class="fa-solid fa-phone"></i>
                                    ...
                                    <li>
                                        <a href="tel:<?php echo e($general_settings->header_contact_number_three); ?>" class="single_product_call_link">
                                            <div class="single_product_call_content">
                                                <i class="fa-solid fa-phone"></i>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="single_product_tab_content">
                                    <div class="single_product_tab_list">
                                        <ul>
                                            <li>
                                                If your product is damaged, defective, incorrect or incomplete at the time
                                                of delivery, please file a return request on call to customer care support
                ...
                <div class="row gy-4">
                    <div class="col-xxl-3 col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="customer_comment_title">
                            <span class="customer_comment_avarage_rating"><?php echo e($average_ratings); ?></span>
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="customer_comment_item">
                            ...
                            <div class="customer_comment_item_percentage_segment">
                                <span style="width: <?php echo e(number_format($product->rating_stars['five_star']/$total_review * 100,2)); ?>%;"></span>
                            </div>
                        ...
                        <div class="customer_comment_item">
                            ...
                            <div class="customer_comment_item_percentage_segment">
                                <span style="width: <?php echo e(number_format($product->rating_stars['four_star']/$total_review * 100,2)); ?>%;"></span>
                            </div>
                            <div class="customer_comment_item_percentage">
                        ...
                        <div class="customer_comment_item">
                            ...
                            <div class="customer_comment_item_percentage_segment">
                                <span style="width: <?php echo e(number_format($product->rating_stars['three_star']/$total_review * 100,2)); ?>%;"></span>
                            </div>
                            <div class="customer_comment_item_percentage">
                        ...
                        <div class="customer_comment_item">
                            ...
                            <div class="customer_comment_item_percentage_segment">
                                <span style="width: <?php echo e(number_format($product->rating_stars['two_star']/$total_review * 100,2)); ?>%;"></span>
                            </div>
                            <div class="customer_comment_item_percentage">
                        ...
                        <div class="customer_comment_item">
                            ...
                            <div class="customer_comment_item_percentage_segment">
                                <span style="width: <?php echo e(number_format($product->rating_stars['one_star']/$total_review * 100,2)); ?>%;"></span>
                            </div>
                            <div class="customer_comment_item_percentage">
                                            ...
                                            <div class="comment_customer_content">
                                                ...
                                                <?php if($review->image): ?>     
                                                    <div class="customer_comment_image">
                                                        <img src="<?php echo e(asset('storage/'.$review->image)); ?>" alt="<?php echo e($review->image); ?>">
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rawcodei/glowryaa.com/resources/views/frontend/pages/product/single_product.blade.php ENDPATH**/ ?>