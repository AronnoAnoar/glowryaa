                ...
                <div class="order_tracking_customer_information">
                    <div class="order_tracking_date_invoice">
                        <div class="order_tracking_date">
                            <p><?php echo e($order->created_at->format('Y/M/d H:m a')); ?></p>
                        </div>
                        ...
                        <div class="order_tracking_customer_address">
                            <div class="order_tracking_customer_item">
                                <strong><?php echo e(@$order->customer->image); ?></strong>
                            </div>
                            <div class="order_tracking_customer_item">
                            ...
                            <div class="order_tracking_customer_item">
                                ...
                                <p><?php echo e(@$order->customer->phone); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-4 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 order-xxl-2 order-xl-2 order-lg-2 order-md-2 order-xxl-2 order-1">
                <div class="order_tracking_order_status_details">
                    <div class="order_tracking_order_cod">
                        <span>COD: <?php echo e($order->total); ?> TK</span>
                    </div>
                    <div class="order_tracking_order_status">
                        <span><?php echo e($order_status); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="order_tracking_sender_information">
                    ...
                    <div class="order_tracking_sender_organization">
                        <h3><?php echo e($general_settings->title); ?></h3>
                    </div>
                    <div class="order_tracking_sender_address">
                        <p>
                            <Strong>Office : </Strong>
                            <?php echo $general_settings->invoice_address_details; ?>

                        </p>
                        <p>
                            <Strong>Phone : </Strong> 
                            <a href="tel:<?php echo e($general_settings->header_contact_number); ?>" class="order_tracking_sender_address_link"><?php echo e($general_settings->header_contact_number); ?></a>
                        </p>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /home/rawcodei/glowryaa.com/resources/views/frontend/components/order_tracking_content.blade.php ENDPATH**/ ?>