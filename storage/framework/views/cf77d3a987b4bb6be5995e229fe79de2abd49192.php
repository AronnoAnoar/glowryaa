    ...
    <section class="sidebar">
        ...
        <div class="user-panel" style="border-bottom:1px solid #ddd;">
            ...
            <div class="pull-left image">
                <?php if($admin != null && !empty($admin->image)): ?>
                    <img src="<?php echo e(asset('storage/' . $admin->image)); ?>" class="img-circle" alt="User Image">
                <?php else: ?>
            ...
            <div class="pull-left info" style="top:1px;">
                <?php if($admin != null): ?>
                    <h4 style="color: #000;"><?php echo e(explode(' ', trim($admin->name))[0]); ?></h4>
                <?php endif; ?>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php if($admin->can('manage wholessale')): ?>
            <?php endif; ?>

            <?php if($admin->can('manage Sale')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php if($admin->can('Manage accounts')): ?>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($admin->can('manage fund transfer')): ?>
                            <li>
            ...
            <?php if($admin->can('manage product')): ?>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if($admin->can('manage purchase')): ?>
                            <li>
            ...
            <?php if($admin->can('manage category')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php if($admin->can('manage attribute')): ?>
            <?php endif; ?>
            <?php if($admin->can('create and manage slider')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php endif; ?>
            <?php if($admin->can('manage supplier')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php if($admin->can('manage customers')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php if($admin->can('manage reports')): ?>
                <li class="treeview">
                    <a href="#">
            ...
            <?php endif; ?>
            <?php if($admin->can('manage basic set up')): ?>
            ...
            <?php if($admin->can('manage company')): ?>
                <li class="treeview">
                    <a href="#">
...
<?php /**PATH /home/hurayaac/glowryaa.com/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>