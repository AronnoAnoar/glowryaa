...
class Customer extends Model implements Authenticatable
{
    ...
    protected $fillable = ['id', 'name', 'user_id', 'phone', 'password', 'status', 'email', 'image', 'address', 'city_id', 'sub_city_id', 'customer_type', 'total_order', 'ip_address', 'remember_token', 'created_at', 'updated_at'] ;


    public static function storeCustomer($data){
          $data=$data ;
          $data['phone']=$data['customer_phone'] ;
          $data['customer_type']= $data['order_type']  ??  1    ;
          $data['total_order']= 1;
